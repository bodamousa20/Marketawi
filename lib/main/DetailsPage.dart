                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  int product_id = providers.product!.id;
                                 

                                 await providers.addProductToCart( providers.userId!, product_id );
                                  if (providers.message == 'Added Successfully') {
                                ...
                                SnackBar(
                                  ...
                                  duration: const Duration(
                                      seconds: 3), // Show message for 3 seconds
                                ),
                              );
                                  }
                                },
